"""
Django settings for immigration_prototype project.
...
SECRET_KEY = 'django-insecure-4c&r4tnfp@+3-^_5^z46aiqwej2y9i40fh0qi*9890u7w8if$s'
...
WSGI_APPLICATION = 'immigration_prototype.wsgi.application'
